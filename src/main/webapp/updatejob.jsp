...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
  ...
  <tr align="center">
    ...
    <td width="29%" height="22" align="left" bgcolor="#E8FFA7" ><input name="name" type="text" class="input" value="<%%>"></td>
    <td width="18%" height="22" bgcolor="#E8FFA7" >性&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
    <td width="23%" height="22" align="left" bgcolor="#E8FFA7" ><input name="sex" type="radio" value="1" <%%>>
      男
  ...
  <tr align="center">
    ...
    <td height="22" align="left" bgcolor="#E8FFA7" ><input type="text" name="age" class="input" value="<%%>"></td>
    <td height="22" bgcolor="#E8FFA7" >职&nbsp;&nbsp;&nbsp;&nbsp;位：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="job" type="text" class="input" value="<%%>"></td>
  </tr>
  <tr align="center">
    <td width="30%" height="27" bgcolor="#E8FFA7" >所学专业：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="specialty" type="text" class="input" value="<%%>"></td>
    <td height="22" bgcolor="#E8FFA7" >工作经验：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="experience" type="text" class="input" value="<%%>"></td>
  </tr>
  <tr align="center">
    <td width="30%" height="27" bgcolor="#E8FFA7" >学&nbsp;&nbsp;&nbsp;&nbsp;历：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="studyeffort" type="text" class="input" value="<%%>"></td>
    <td height="22" bgcolor="#E8FFA7" >毕业学校：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="school" type="text" class="input" value="<%%>"></td>
  </tr>
  <tr>
    <td width="30%" height="27" align="center" bgcolor="#E8FFA7" >电&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="tel" type="text" class="input" value="<%%>"></td>
    <td height="22" align="center" bgcolor="#E8FFA7" >Email：</td>
    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="email" type="text" class="input" value="<%%>"></td>
  </tr>
  <tr>
