...
<!------->		
  ...
  <tr>
    ...
    <td height="22" align="center" bgcolor="#FFFFFF" ><%%></td>
    <td height="22" align="center" bgcolor="#FFFFFF" ><%%></td>
    <td height="22" align="center" bgcolor="#FFFFFF" ><a href="detaileducate.do?educate=<%=educate%>&action=detaileducate&id=<%%>">详细</a>&nbsp;&nbsp;<a href="modifyeducate.do?action=deleteeducate&educate=<%%>">删除</a>
      <%if(!"1".equals(educate)){%>&nbsp;&nbsp;<a href="updateeducate.do?educate=1&action=detaileducate&id=<%%>">培训完成</a><%}%></td>
  </tr>
  <%
  %>
  <tr>
