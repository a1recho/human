                ...
                <tr>
                    <td height="431" valign="top" bgcolor="#C5DF7E">
                        ...
                        <table width="94%" border="0" align="center" cellpadding="0" cellspacing="1"
                            ...
                            %>
                            <tr>
                                <td height="22" align="center" bgcolor="#FFFFFF"><%=e.getId()%>
                                </td>
                                <td height="22" align="center" bgcolor="#FFFFFF"><%=e.getEmployeeName()%>
                                </td>
                                <td height="22" align="center" bgcolor="#FFFFFF"><%=e.getSex()%>
                                </td>
                                <td height="22" align="center" bgcolor="#FFFFFF"><%=e.getAge()%>&nbsp</td>
                                <td height="22" align="center" bgcolor="#FFFFFF"><%=e.getPost().getPostName()%>
                                </td>
                                <td height="22" align="center" bgcolor="#FFFFFF"><%=e.getDept().getDeptName()%>&nbsp;
                                </td>
                                <td height="22" align="center" bgcolor="#FFFFFF"><%=e.getSalary()%>
                                </td>
                                <td height="22" align="center" bgcolor="#FFFFFF"><a
                                        href="updateUserInformation.jsp?id=idNo&idNo=<%=e.getId()%>&id=name&name=<%=e.getEmployeeName()%>&id=sex&sex=<%=e.getSex()%>&id=age&age=<%=e.getAge()%>&id=PostName&PostName=<%=e.getPost().getPostName()%>&id=DeptName&DeptName=<%=e.getDept().getDeptName()%>&id=salary&salary=<%=e.getSalary()%>">修改</a>&nbsp;&nbsp;<a
                                        href="/delete?idNo=<%=e.getId()%>">删除</a></td>
                            </tr>
                            ...
                            %>
                            <tr>
                                <td height="22" colspan="7" align="center" bgcolor="#E8FFA7">对不起，没有该员工信息！！！</td>
                            </tr>
                            <%}%>

                        </table>
                       <div align="center"> <input type="button" value="返回" onclick="window.location.href='listUser'"></div>
                    </td>
                </tr>
            </table>
        </td>
