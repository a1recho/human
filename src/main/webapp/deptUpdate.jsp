                ...
                <tr>
                    <td height="431" valign="top" bgcolor="#C5DF7E">
                        ...
                        <table width="94%" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="0"
                            ...
                            <tr>
                                <td height="22" colspan="2" align="center" class="word_yellow">-修改部门信息-</td>
                            </tr>
                            <form name="userForm" method="post" action="updateDept"
                                  onSubmit="return userValidate();">
                                <tr>
                                    <td width="33%" height="27" align="center" bgcolor="#E8FFA7">部门编号：</td>
                                    <td height="27" align="left" bgcolor="#E8FFA7"><input name="id" type="text"
                                                                                          class="input" value="<%=request.getParameter("idNo")%>" readonly></td>
                                </tr>
                                <tr>
                                    <td width="33%" height="27" align="center" bgcolor="#E8FFA7">部门名称：</td>
                                    <td height="27" align="left" bgcolor="#E8FFA7"><input name="deptName" type="text"
                                                                                          class="input" value="<%=request.getParameter("DeptName")%>"></td>
                                </tr>

                                <tr>
                                    <td width="33%" height="27" align="center" bgcolor="#E8FFA7">部门描述：</td>
                                    <td height="27" align="left" bgcolor="#E8FFA7"><textarea name="deptContent" cols="30" rows="6"
                                                                                             class="input"><%=request.getParameter("DeptContent")%></textarea></td>
                                </tr>
                                ...
                                <tr>
                                    <td height="27" colspan="2" align="center" bgcolor="#E8FFA7"><input name="Submit"
                                                                                                        ...
                                                                                                        value="修改">
                                        &nbsp;&nbsp;
                                        <input  type="button" class="button" onclick="window.location.href='listDept'" value="返回">
                                </tr>
                            </form>
                        </table>
