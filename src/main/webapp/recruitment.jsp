                        ...
                        <table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
                            ...
                            <form name="jobForm" method="post" action="/recruitment" onSubmit="return jobValidate();" >
                                <tr align="center">
                                    ...
                                    <td width="29%" height="22" align="left" bgcolor="#E8FFA7" ><input name="postName" type="text" class="input"></td>
                                ...
                                <tr align="center">
                                    ...
                                    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="education" type="text" class="input"></td>
                                </tr>
                                <tr align="center">
                                    ...
                                    <td height="22" align="left" bgcolor="#E8FFA7" ><input name="phone" type="text" class="input"></td>
                                </tr>
                                <tr>
