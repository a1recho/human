                ...
                <tr>
                    <td height="431" valign="top" bgcolor="#C5DF7E">
                        ...
                        <table width="94%" border="0" align="center" cellpadding="0" cellspacing="1"
                            ...
                            <tr>
                                <td height="22" colspan="4" align="center"><strong class="word_yellow">-简历信息-</strong>
                                </td>
                            </tr>
                            <%
                            ...
                            %>
                            <form name="jobForm" method="post" action="updateResume" onSubmit="return jobValidate();">
                                <tr align="center">
                                    <td style ="display:none"width="30%" height="27" bgcolor="#E8FFA7">简历编号：</td>
                                    <td style ="display:none"width="29%" height="22" align="left" bgcolor="#E8FFA7"><input name="id"
                                                                                                      type="text"
                                                                                                      value="<%=re.getId()%>"
                                                                                                      class="input">
                                    </td>
                                ...
                                <tr align="center">
                                    ...
                                    <td height="22" align="left" bgcolor="#E8FFA7"><input name="phone" type="text"
                                                                                          class="input"  value="<%=re.getPhone()%>"></td>
                                </tr>
                                <tr>
                                    <td width="30%" height="22" align="center" bgcolor="#E8FFA7">备注：</td>
                                    <td height="22" colspan="3" align="left" bgcolor="#E8FFA7"><textarea name="content"
                                                                                                         cols="50"
                                                                                                         rows="6"
                                                                                                         class="input" ><%=re.getContent()%> </textarea>
                                ...
                                <tr>
                                    <td height="30" colspan="4" align="center" bgcolor="#E8FFA7"><input name="Submit"
                                                                                                        ...
                                                                                                        class="button"
                                                                                                        value="修改">&nbsp;&nbsp;
                                        <input name="Submit2" type="button" class="button"  onclick="window.location.href='deleteResume/<%=re.getId()%>'"  value="删除">
                                    </tr>
                                <%
                                    }
                                } else {
                                %>
                                <tr>
                                    <td height="22" colspan="7" align="center" bgcolor="#E8FFA7">对不起，没有简历信息！！！</td>
                                </tr>
                                <%}%>
                                <tr>
