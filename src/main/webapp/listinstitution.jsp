...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" >
  ...
  <tr>
    ...
    <td height="22" align="center" bgcolor="#FFFFFF" ><%%></td>
    <td height="22" align="center" bgcolor="#FFFFFF" ><a href="detailinstitution.do?action=detailinstitution&id=<%%>">详细</a>&nbsp;&nbsp;<a href="modifyinstitution.do?action=deleteinstitution&id=<%%>">删除</a></td>
  </tr>
  <%
  %>
  <tr>
