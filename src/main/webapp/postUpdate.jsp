                ...
                <tr>
                    <td height="431" valign="top" bgcolor="#C5DF7E">
                        ...
                        <table width="94%" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="0"
                            ...
                            <tr>
                                <td height="22" colspan="2" align="center" class="word_yellow">-修改职位信息-</td>
                            </tr>
                            <form name="userForm" method="post" action="/updatePost"
                                  onSubmit="return userValidate();">
                                <tr>
                                    <td width="33%" height="27" align="center" bgcolor="#E8FFA7">职位编号：</td>
                                ...
                                <tr>
                                    ...
                                    <td height="27" align="left" bgcolor="#E8FFA7"><textarea name="PostContent" cols="30" rows="6"
                                                                                             class="input"><%=request.getParameter("PostContent")%></textarea></td>
                                </tr>
