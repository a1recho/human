...
<table width="94%"  border="0" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" bgcolor="#97B150" style="padding:5pt;">
  ...
  <%}%>
  <tr>
    <td height="22" colspan="4" align="center" bgcolor="#E8FFA7" ><%if(!"1".equals(educate)){%><a href="updateeducate.do?action=detaileducate&id=<%%>">修改</a>&nbsp;&nbsp;<%}%><a href="#" onClick="javascript:history.back();">返回</a></td>
  </tr>
  <%%>
  <tr>
